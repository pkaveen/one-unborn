        ...
        <div class="content">
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td><strong>{{ $feasibility->feasibility_request_id ?? 'N/A' }}</strong></td>
                </tr>
                <tr>
                    <td class="label">Client:</td>
                    <td>{{ $feasibility->client->client_name ?? 'N/A' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{ $feasibility->area ?? 'N/A' }}, {{ $feasibility->district ?? 'N/A' }} - {{ $feasibility->pincode ?? 'N/A' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><span class="status-badge status-{{ strtolower($previousStatus) }}">{{ $previousStatus }}</span></td>
                </tr>
                @endif
                <tr>
                ...
                <tr>
                    ...
                    <td>{{ $actionBy->name ?? 'System' }} ({{ $actionBy->email ?? 'N/A' }})</td>
                </tr>
                @endif
                <tr>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
                <p style="margin: 0; color: #666;">
                    Best regards,<br>
                    <strong>{{ config('app.name', 'Network Solutions Team') }}</strong>
                </p>
            </div>
        </div>
    </div>
