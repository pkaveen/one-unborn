                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="mail_encryption" class="form-control" 
                               value="{{ old('mail_encryption', $setting->mail_encryption ?? 'tls') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="email" name="mail_from_address" class="form-control" 
                               value="{{ old('mail_from_address', $setting->mail_from_address ?? '') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">From Name</label>
                        <input type="text" name="mail_from_name" class="form-control" 
                               value="{{ old('mail_from_name', $setting->mail_from_name ?? $company->company_name) }}" required>
                    </div>
                </div>
