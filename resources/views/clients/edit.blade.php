            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" 
                           value="{{ $client->client_code }}" readonly>
                </div>
            </div>
...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <input type="email" name="invoice_email" class="form-control"
               value="{{ old('invoice_email', $client->invoice_email) }}" placeholder="Enter invoice email">
    </div>
    <div class="col-md-6">
        <label class="form-label">Invoice CC</label>
        <input type="email" name="invoice_cc" class="form-control"
               value="{{ old('invoice_cc', $client->invoice_cc) }}" placeholder="Enter invoice CC email">
    </div>
</div>
