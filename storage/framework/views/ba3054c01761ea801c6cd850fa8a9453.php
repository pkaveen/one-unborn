        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-dark">
                    <h4 class="mb-0">
                        <i class="bi bi-pencil"></i> Edit Purchase Order - <?php echo e($purchaseOrder->po_number); ?>
...
unset($__errorArgs, $__bag); ?>" 
                       id="po_number" name="po_number" value="<?php echo e(old('po_number', $purchaseOrder->po_number)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="po_date" name="po_date" value="<?php echo e(old('po_date', $purchaseOrder->po_date->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $closedFeasibilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feasibilityStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($feasibilityStatus->feasibility->id); ?>" 
                                                <?php echo e(old('feasibility_id', $purchaseOrder->feasibility_id) == $feasibilityStatus->feasibility->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- 
                        <div id="clientDetails" class="row mb-4 <?php echo e($purchaseOrder->feasibility_id ? '' : 'd-none'); ?>">
                            <div class="col-12">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Company Name:</strong> <span id="clientCompanyName"><?php echo e($purchaseOrder->feasibility->client->company_name ?? 'N/A'); ?></span></p>
                                                <p><strong>Contact Person:</strong> <span id="clientContactPerson"><?php echo e($purchaseOrder->feasibility->client->contact_person ?? 'N/A'); ?></span></p>
                                                <p><strong>Email:</strong> <span id="clientEmail"><?php echo e($purchaseOrder->feasibility->client->email ?? 'N/A'); ?></span></p>
                                            </div>
                                            <div class="col-md-6">
                                                <p><strong>Phone:</strong> <span id="clientPhone"><?php echo e($purchaseOrder->feasibility->client->phone ?? 'N/A'); ?></span></p>
                                                <p><strong>Address:</strong> <span id="clientAddress"><?php echo e($purchaseOrder->feasibility->client->address ?? 'N/A'); ?></span></p>
                                                <p><strong>GST Number:</strong> <span id="clientGST"><?php echo e($purchaseOrder->feasibility->client->gst_number ?? 'N/A'); ?></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="arc_per_link" name="arc_per_link" value="<?php echo e(old('arc_per_link', $purchaseOrder->arc_per_link)); ?>" required onchange="calculateTotal()">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="otc_per_link" name="otc_per_link" value="<?php echo e(old('otc_per_link', $purchaseOrder->otc_per_link)); ?>" required onchange="calculateTotal()">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="static_ip_cost_per_link" name="static_ip_cost_per_link" value="<?php echo e(old('static_ip_cost_per_link', $purchaseOrder->static_ip_cost_per_link)); ?>" required onchange="calculateTotal()">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="no_of_links" name="no_of_links" value="<?php echo e(old('no_of_links', $purchaseOrder->no_of_links)); ?>" required onchange="calculateTotal()">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="contract_period" name="contract_period" value="<?php echo e(old('contract_period', $purchaseOrder->contract_period)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      id="remarks" name="remarks" rows="3" placeholder="Enter any additional remarks..."><?php echo e(old('remarks', $purchaseOrder->remarks)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-12 text-end">
                                <a href="<?php echo e(route('sm.purchaseorder.view', $purchaseOrder->id)); ?>" class="btn btn-secondary me-2">
