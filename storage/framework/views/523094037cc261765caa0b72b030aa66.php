...
<li class="nav-item">
    <a class="nav-link text-white d-flex justify-content-between align-items-center"
       ...
       aria-expanded="<?php echo e(request()->is('operations/feasibility*') ? 'true' : 'false'); ?>"
       aria-controls="operationsMenu">
        <span><i class="bi bi-gear-wide-connected"></i> operations</span>
        <i class="bi bi-chevron-down small"></i>
    </a>

    <div class="collapse <?php echo e(request()->is('operations/feasibility*') ? 'show' : ''); ?>" id="operationsMenu">
        <ul class="nav flex-column ms-3 mt-1">
            
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isOpenActive ? 'active' : ''); ?>"
            ...
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isInProgressActive ? 'active' : ''); ?>"
            ...
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isClosedActive ? 'active' : ''); ?>"
