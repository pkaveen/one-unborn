...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', $profile->email)); ?>" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Aadhaar Upload</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">PAN Upload</label>
