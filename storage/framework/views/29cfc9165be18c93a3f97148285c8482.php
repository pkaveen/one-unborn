    ...
    <div class="tab-content" id="whatsappTabsContent">
        ...
        <div class="tab-pane fade show active" id="official" role="tabpanel">
            <div class="card shadow border-0 p-4">
                ...
                <form action="<?php echo e(route('whatsapp.settings.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('whatsapp.settings.update')); ?>" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 p-4">
                            ...
                            <input type="url" name="unofficial_api_url" value="<?php echo e(old('unofficial_api_url', $settings->unofficial_api_url ?? 'https://wa.unbornsms.in/api/send.php')); ?>" 
...
<!--                   
                    ...
                    <a href="<?php echo e(route('whatsapp.test')); ?>" class="btn btn-info px-4 ms-2" target="_blank">
